...
class ServiceController {
  ...
  public async update(req: Request, res: Response) {
    ...
    const updatedService = await updateServiceUseCase.execute(+req.params.id, req.body);
  ...
  public async getListPaginated(req: Request, res: Response) {
    ...
    const getPaginatedServiceUseCase = new GetPaginatedServiceUseCase(ServicesRepository);
